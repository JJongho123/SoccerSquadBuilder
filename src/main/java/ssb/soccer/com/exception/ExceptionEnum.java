...
public enum ExceptionEnum {
    ...
    USER_NOT_FOUND_EXCEPTION(HttpStatus.BAD_REQUEST, "CE0005", "아이디가 존재하지 않습니다."),

    TEAM_CREATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "CE0006", "팀 생성에 실패하였습니다."),
    TEAM_MEMBERSHIP_CREATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "CE0007", "팀 멤버십 생성에 실패하였습니다."),
